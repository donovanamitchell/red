      ...
      describe Automatic do
        ...
        describe "insert_game_obj" do
          it "should create a new layer if empty" do
            ...
            organizer = Automatic.new
            game_object = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
          ...
          it "should add to the layer if the object can be rendered in it" do
            ...
            shader = SF::Shader.new
            organizer = Automatic.new
            game_object_1 = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
            game_object_2 = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
        ...
        describe "arrange" do
          ...
          it "should order the objects according to the graph" do
            texture = SF::Texture.new
            organizer = Automatic.new
            a = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
            b = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
            c = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
          ...
          it "should resolve ties based on the last used texture and shader" do
            ...
            b = SF::Texture.new
            organizer = Automatic.new
            object_1 = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
            object_2 = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
            object_3 = RenderableGameObject.new(SF.vector2(0,0), NilRenderable.new)
